programa
{
  ...
  inteiro startX
  cadeia lastKeyPressed = ""

  funcao mover(cadeia direction){
    se((direction == "a" ou lastKeyPressed == "a") e matriz[moverX][moverY - 1] != "Nada"){
      matriz[moverX][moverY] = "Caminho"
      matriz[moverX][moverY - 1] = charCharacter
      moverY -= 1
    }
    se((direction == "d" ou lastKeyPressed == "d") e matriz[moverX][moverY + 1] != "Nada"){
      matriz[moverX][moverY] = "Caminho"
      matriz[moverX][moverY + 1] = charCharacter
      moverY += 1
    }
    se((direction == "s" ou lastKeyPressed == "s") e matriz[moverX + 1][moverY] != "Nada"){
      matriz[moverX][moverY] = "Caminho"
      matriz[moverX + 1][moverY] = charCharacter
      moverX += 1
    }
    se((direction == "w" ou lastKeyPressed == "w") e matriz[moverX - 1][moverY] != "Nada"){
      matriz[moverX][moverY] = "Caminho"
      matriz[moverX - 1][moverY] = charCharacter
      moverX -= 1
    }
    ...
    inteiro tentativas = 0
		enquanto(mapaBom == falso){
			...
			// Start aleatório
			startX = Util.sorteia(1, tamanhoMapaX - 2)
      moverX = startX
      moverY = 0
			matriz[startX][0] = "O"
